      ...
      switch ($fid)
      {
        ...
        case 2:
          if ($ftype == TType::STRUCT) {
            $this->pos = new \tank\player\Position();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 5:
          if ($ftype == TType::STRUCT) {
            $this->flagPos = new \tank\player\Position();
